...
public abstract class YCarrelloPortalePO extends EntitaAzienda implements BusinessObject, Authorizable, Deletable, Conflictable {
	...
	protected boolean iGestioneContoDep;
	...
	public boolean isGestioneContoDep() {
		return iGestioneContoDep;
	}

	public void setGestioneContoDep(boolean iGestioneContoDep) {
		this.iGestioneContoDep = iGestioneContoDep;
		setDirty();
	}
