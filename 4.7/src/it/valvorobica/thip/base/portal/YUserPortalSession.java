...
public class YUserPortalSession {
	...
	protected YUserPortal userPortalPanthera = null;
	
	public YUserPortal getUserPortalPanthera() {
		return userPortalPanthera;
	}

	public void setUserPortalPanthera(YUserPortal userPortalPanthera) {
		this.userPortalPanthera = userPortalPanthera;
	}
