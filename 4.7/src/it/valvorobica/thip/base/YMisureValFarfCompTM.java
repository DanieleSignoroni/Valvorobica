...
public class YMisureValFarfCompTM extends TableManager {
	...
	public static final String ID_TP_COMP = "ID_TP_COMP";
	...
	public static final String COLATA_COMP = "COLATA_COMP";

	public static final String TABLE_NAME = SystemParam.getSchema("THIPPERS") + "YMISURE_VAL_FARF_COMP";

	private static TableManager cInstance;

	private static final String CLASS_NAME = it.valvorobica.thip.base.YMisureValFarfComp.class.getName();

	public synchronized static TableManager getInstance() throws SQLException {
		if (cInstance == null) {
			cInstance = (TableManager) Factory.createObject(YMisureValFarfCompTM.class);
		}
		return cInstance;
	}

	public YMisureValFarfCompTM() throws SQLException {
		super();
	}
	...
	protected void initializeRelation() throws SQLException {
		...
		addAttribute("ColataComp", COLATA_COMP);
		addAttribute("IdAzienda", ID_AZIENDA);
		addAttribute("IdTpComp", ID_TP_COMP);
