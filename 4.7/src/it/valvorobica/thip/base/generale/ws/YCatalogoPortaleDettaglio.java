...
public class YCatalogoPortaleDettaglio extends YPortalGenRequestJSON {
		...
		for (Iterator iterator = keys.iterator(); iterator.hasNext();) {
			...
			try {
				...
				if (art != null) {
					...
					if (condVen != null) {
						BigDecimal prezzo = condVen.getPrezzo() != null ? condVen.getPrezzo() : BigDecimal.ZERO;
						if(prezzo == null) {
							//continue;
						}
	...
	public static BigDecimal getOrdinatoCarrello(String idUtente,String idArticolo) {
