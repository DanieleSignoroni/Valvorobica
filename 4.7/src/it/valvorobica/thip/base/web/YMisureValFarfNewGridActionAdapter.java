...
public class YMisureValFarfNewGridActionAdapter extends GridActionAdapter {
	...
	public static final String RES = "it.valvorobica.thip.base.resources.YImportazioneMisureValvFarfBatch";
	...
	protected void otherActions(ClassADCollection cadc, ServletEnvironment se) throws ServletException, IOException {
		...
		if (action.equals(IMPORTA_MISURE)) {
			se.sendRequest(getServletContext(), "it/valvorobica/thip/base/YImportazioneMisureValvFarfBatch.jsp", true);
		} else {
