...
function loadBoValues(businessClass) {
	...
	var url = "/" + webAppPath + "/" + servletPath + "/it.valvorobica.thip.base.portal.web.YKeyValuesLoader?ClassName=" + businessClass+"&thKey="+key;
...
function caricaImg(dimensione, actionName) {
	var idUpload = '';
	var urlImg = '';
	var index;
...
function salvaFile(actionName) {
	runActionDirect(actionName, "action_submit", document.getElementById("thClassName").value, document.getElementById("thKey").value, "errorsFrame", "no");
}
...
function selectByDescription(description) {
	var select = document.getElementById("KeyValue");
