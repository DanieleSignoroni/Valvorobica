...
%>
								...
								<tr>
									<td valign="top"><label>Preview Immagine</label></td>
									<td><img id="imgSuDB" style="height:200px;width:300px;"></td>
								</tr>
							</table>
							</td>
							<td valign="top">
								<table>
								<tr>
								    <td valign="top"><%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "YImgCatalogoPortale", "Descrizione", null); 
   label.setParent(YImgCatalogoPortaleForm); 
%><label class="<%=label.getClassType()%>" for="Descrizione"><%label.write(out);%></label><%}%></td>
									<td valign="top"><% 
  WebTextInput YImgCatalogoPortaleDescrizione =  
