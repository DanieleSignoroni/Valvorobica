...
<body onload="apriSchedaAnagrafica()">
	<%
	} else if(userPortalSession.getTipoUser().equals(YUserPortalSession.FORNITORE) && 
			(userPortalSession.getSupplierOfferKey() != null && !userPortalSession.getSupplierOfferKey().equals("null"))){
	%>
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="sidebar"
			...
			<ul class="nav nav-pills flex-column mb-auto">
				...
				if (userPortalSession.getTipoUser().equals(YUserPortalSession.FORNITORE)){
				%>
				<li><a href="#" class="nav-link text-white pl-2" id="16"
					onclick="submitJFun(this)"> Allega certificati </a></li>
				<%
				}
				%>
			</ul>
...
$(document).ready(function () {
    $('#sidebarCollapse').on('click', function () {
		...
		function apriSchedaAnagrafica() {
			//document.getElementById("preloader").childNodes[1].classList.add('spinnerSoftre');
			//document.getElementById("preloader").childNodes[1].classList.remove('spinner');
			var txt = '<p><span style="color:#e74c3c"><u><strong>ATTENZIONE: il vecchio portale VALVOBUSINESS verr&agrave; dismesso il 01/03/2024. Esortiamo la gentile clientela a scaricare tutti i file (inclusi i certificati) non ancora archiviati prima di tale data.</strong></u></span></p>';
