...
<body class="noscrollbar"
	...
	<script>
		...
		function renderCard(item, container) {
				...
				var cardContent = '<div class="card" style="cursor:pointer;" onclick="toggleChildren(this)" id="'+item.text+'"><img class="img-fluid" src="'+item.img+'"></img><div class="card-img-overlaysoftre"><h5 class="card-title">'+item.text+'</h5></div></div>';
...
// 	                    parentPath += '/';
		...
		function contactUdsModal(event){
			...
			$('#ContactUsProductId').val(tr.querySelector('[name=IdArticoloPth]').innerHTML);ù
		}
