...
%>
				  ...
				  <tr>
					  <td><% 
  WebCheckBox YAziendeUserPortalGestioneContoDep =  
     new com.thera.thermfw.web.WebCheckBox("YAziendeUserPortal", "GestioneContoDep"); 
  YAziendeUserPortalGestioneContoDep.setParent(YAziendeUserPortalForm); 
%>
<input id="<%=YAziendeUserPortalGestioneContoDep.getId()%>" name="<%=YAziendeUserPortalGestioneContoDep.getName()%>" type="checkbox" value="Y"><%
  YAziendeUserPortalGestioneContoDep.write(out); 
%>
</td>
				  </tr>
                </table>
