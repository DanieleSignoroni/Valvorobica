...
if(userPortalSession == null){
	...
	case YUtilsPortal.FUNZIONE_CARRELLO:
		...
		se.sendRequest(getServletContext(), url, false);
		break;
	case YUtilsPortal.FUNZIONE_GIACENZE_CONTO_DEP:
		url = "it/valvorobica/thip/base/portal/YSchedaGiacenzeContoDeposito.jsp";
		se.sendRequest(getServletContext(), url, false);
		break;
	case YUtilsPortal.FUNZIONE_CARRELLO_CONTO_DEP:
		url = "it/valvorobica/thip/base/portal/YSchedaCarrelloContoDeposito.jsp";
		se.sendRequest(getServletContext(), url, false);
		break;
	default:
